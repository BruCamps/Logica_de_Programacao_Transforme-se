programa {
  ...
  funcao inicio() {
        ...
        para(i=0; i < 10; i++){
            ...
            // Laço de Repetição que não permite outras opções além das exibidas nas questões
  ...
  // Função para exibição da Mensagem Final
  ...
  // Função que exibe o gabarito e respostas do Usuário
